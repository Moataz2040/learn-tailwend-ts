  ...
  return (
    <div className="flex">
      <div
        ...
        } min-h-screen p-5 pt-8 duration-300 ${
          open ? "w-72" : "w-20"
        } relative z-50`}
      >
        <BsArrowRight
          className={`bg-white text-3xl rounded-full absolute -left-3 top-9 border border-gray-300
          ...
          {Menus.map((menu, index) => (
            <div key={index}>
              <li
                ...
                hover:bg-blue-400 rounded-md ${menu.spacing ? "mt-9" : "mt-2"}`}
              >
...
p-2 px-5 hover:bg-blue-400 rounded-md duration-300"
                    >
                      {submenuItem.title}
                    </li>
                  ))}
